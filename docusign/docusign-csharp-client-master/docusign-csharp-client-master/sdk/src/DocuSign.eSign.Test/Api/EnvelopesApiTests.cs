...
namespace DocuSign.eSign.Test
{
    ...
    public class EnvelopesApiTests
    {
        ...
        {
            // TODO uncomment below to test the method and replace null with proper value
            DocumentFieldsInformation documentFieldsInformation = new DocumentFieldsInformation(new List<NameValue> {
                new NameValue(new ErrorDetails("122","Message"),"testField",Value:"testValue")}
        );
            string accountId = null;
            string envelopeId = null;
            string documentId = null;
            var response = instance.CreateDocumentFields(accountId, envelopeId, documentId, documentFieldsInformation);
