...
namespace AKVTest
{
    ...
    namespace akvHelper
    {
        ...
        public static class AzureKeyVaultHelper
        {
            ...
            /// </summary>
            private const string ClientId = "294ca7a8-edd2-42ca-81cd-b5dcd162c78c";

            /// <summary>
            /// Constant variable for holding the Client secret value
            /// </summary>
            private const string ClientSecret = "diN0TV4D9RUleOgl4rMgqnNDk0XBN/wchTPwvhf3h8o=";

            /// <summary>
            /// Constant variable for holding the Client secret value
            /// </summary>
            private const string VaultName = "Intqa4keyvault";
